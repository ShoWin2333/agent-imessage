...
export const gatewayTools = [
  ...
  { type: 'function', name: 'ask_imessage_user', deferLoading: false, description: 'Ask the user a question and wait for their answer over iMessage.', inputSchema: { type: 'object', properties: { question: { type: 'string' } }, required: ['question'], additionalProperties: false } },
]
